    ...
    <div className={cn("flex items-center gap-3 py-3 border-b last:border-0")}>
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-1.5 mt-0.5 min-w-0 flex-wrap">
          ...
          <Badge variant="secondary" className="text-xs py-0 px-1.5 h-4 shrink-0">
            {catLabel}
          </Badge>
          {subcatLabel && (
            <Badge variant="outline" className="text-xs py-0 px-1.5 h-4 shrink-0 text-muted-foreground">
              {subcatLabel}
            </Badge>
          )}
          {t.source === "bot" && (
